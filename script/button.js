// function titlecopy() {
//     var title = document.getElementById("main-title").innerText;
//     var view = document.getElementById("view-count").innerText;
